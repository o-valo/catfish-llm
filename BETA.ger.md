...
**Sprache:** Deutsch · [English](BETA.md)
...
Kommentare vom Modell. Alles läuft auf dem catfish-llm-Rechner – dein Chat geht
...
Frag den Betreiber nach der Adresse des catfish-llm-Rechners. Zwei Fälle:
...
Auf dem catfish-llm-Rechner prüft `./start_proxy.sh check` die komplette
...
**Ohne OpenWebUI** – direkt im Terminal (auf dem catfish-llm-Rechner):
...
3. **Log der Anfrage:** die letzten ~30 Zeilen aus `~/catfish-llm/proxy.log`
