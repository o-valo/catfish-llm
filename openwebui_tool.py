...
author: Olav
version: 1.0
description: Bindet die Schach-App (Stockfish + Spielverwaltung) des
             chess-proxys als natives OpenWebUI-Tool ein.
"""
...
class Tools:
    ...
    def zug_machen(self, session_id: str, zug: str) -> str:
        """Führt einen Schachzug aus (SAN wie 'Nf3'/'e4' oder UCI wie 'g1f3').

        :param session_id: Sitzungs-ID (von OpenWebUI bereitgestellt)
        :param zug: Der auszuführende Zug
        """
        return self._call("zug_machen", session_id, zug=zug)

    def beste_zuege(self, session_id: str, n: int = 3) -> str:
        """Liefert die n besten Züge laut Stockfish für die aktuelle Stellung.
