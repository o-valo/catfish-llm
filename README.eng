# chess – an LLM plays chess (with Stockfish in the background)
...
test cases and how to report issues are in [`BETA.md`](BETA.md) (in German).
...
### A) Tool API for OpenWebUI (chess-proxy)
...
- **URL:** `http://<address-of-the-chess-machine>:8300/v1`
...
| `PROXY_MODEL_NAME` | Model name the proxy reports to clients (default `gambit-schach`) |
